...
#TODO:  I neuron Solution

list=[10,20,30,10,20,10,40,50,60,10,60,70,80,60]
freq = {}
for element in list:
  freq[element] = list.count(element)
...
# TODO: List Comprehension
list=[10,20,30,10,20,10,40,50,60,10]
elementtoFind = int(input('Enter the element you want to check:'))
result = [i for i in range(len(list)) if list[i] == elementtoFind]
print('Indices of the element',elementtoFind,"are:",result)
